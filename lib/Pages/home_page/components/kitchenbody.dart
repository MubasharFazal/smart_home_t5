...
import 'package:smart_home/model_view_controller/kitchen_view_model.dart';

class KitchenBody extends StatelessWidget {
  final KitchenViewModel model;
  const KitchenBody({Key? key, required this.model}) : super(key: key);
